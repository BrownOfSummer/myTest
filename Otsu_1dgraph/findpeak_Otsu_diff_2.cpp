/*************************************************************************
    ...
    > Created Time: 2016-10-14 09:03:59
 ************************************************************************/
// consider the thirdMax
#include<iostream>
#include<stdio.h>
#include<stdlib.h>
...
int main(int argc, char* argv[])
{
    ...
    double thirdMax = 0;
    for(i = 1; i < ndiff; i ++){
        if(data2[i].score < secondMax){
            thirdMax = data2[i].score;
            break;
        }
        else
            thirdMax = -1;
    ...
    fprintf(stdout, "minScore = %lf; maxScore = %lf; secondMax = %lf; thirdMax = %lf\n", minScore, maxScore, secondMax, thirdMax);
    ...
    double step = (maxScore - secondMax) * (maxScore - secondMax) / (secondMax - thirdMax) / 2;
